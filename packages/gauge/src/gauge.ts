...
export type GuageTextSize = { width: number, height: number, scale: number };
...
export class HPCCGaugeElement extends HPCCSVGElement {
    ...
    protected calcSize(textElement: d3.Selection<SVGGElement, unknown, any, any>, width: number, height: number): GuageTextSize {
